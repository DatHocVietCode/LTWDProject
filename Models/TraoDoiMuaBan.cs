...
public partial class TraoDoiMuaBan : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Account>(entity =>
        {
            ...
            entity.HasIndex(e => e.UserName, "UQ__Account__C9F284569627C52E").IsUnique();
        ...
        modelBuilder.Entity<Bought>(entity =>
        {
            ...
            entity.HasOne(d => d.IDUserNavigation).WithMany(p => p.Boughts)
                ...
                .HasConstraintName("FK__Bought__IDUser__4D94879B");
        });
        ...
        modelBuilder.Entity<Cart>(entity =>
        {
            ...
            entity.HasOne(d => d.IDProductNavigation).WithMany(p => p.Carts)
                ...
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__Cart__IDProduct__4E88ABD4");
        ...
        {
            entity.HasKey(e => new { e.DataTimeCreate, e.IDUser, e.IDProduct }).HasName("PK__Comment__18F870605C9CF302");
        ...
        {
            entity.HasKey(e => e.IDProduct).HasName("PK__Inventor__4290D179E52E1A59");
            ...
            entity.HasMany(d => d.IDUsers).WithMany(p => p.IDProducts)
                .UsingEntity<Dictionary<string, object>>(
                    ...
                    r => r.HasOne<User>().WithMany()
                        ...
                        .OnDelete(DeleteBehavior.ClientSetNull)
                        .HasConstraintName("FK__FaVProduc__IDUse__5165187F"),
                    l => l.HasOne<Inventory>().WithMany()
                        .HasForeignKey("IDProduct")
                        .OnDelete(DeleteBehavior.ClientSetNull)
                        .HasConstraintName("FK__FaVProduc__IDPro__5070F446"),
                    j =>
                    {
                        j.HasKey("IDProduct", "IDUser").HasName("PK__FaVProdu__AC3EBCE44D18E46E");
        ...
        {
            entity.HasKey(e => new { e.IDInvoice, e.IDProduct }).HasName("PK__LstProdu__C98150679E55310A");
            ...
            entity.HasOne(d => d.IDInvoiceNavigation).WithMany(p => p.LstProducts)
                ...
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__LstProduc__IDInv__5441852A");

            entity.HasOne(d => d.IDProductNavigation).WithMany(p => p.LstProducts)
                .HasForeignKey(d => d.IDProduct)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__LstProduc__IDPro__5535A963");
        });

        modelBuilder.Entity<Priority>(entity =>
        {
            entity.HasKey(e => new { e.IDuser, e.IDproduct }).HasName("PK__Priority__83F81D44897E20AA");
            ...
            entity.HasOne(d => d.IDproductNavigation).WithMany(p => p.Priorities)
                .HasForeignKey(d => d.IDproduct)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__Priority__IDprod__5629CD9C");

            entity.HasOne(d => d.IDuserNavigation).WithMany(p => p.Priorities)
                .HasForeignKey(d => d.IDuser)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__Priority__IDuser__571DF1D5");
        });

        modelBuilder.Entity<Shop>(entity =>
        {
            entity.HasKey(e => e.IDShop).HasName("PK__Shop__C52550282D4A460C");
            ...
            entity.Property(e => e.Visits).HasDefaultValueSql("((0))");
        ...
        {
            entity.HasKey(e => e.ID).HasName("PK__User__3214EC2761E91D72");
